...
def test_to_x_y():
    assert CubicCode.to_x_y(6) == (0, -1)
    assert CubicCode.to_x_y(9) == (2, 0)
    assert CubicCode.to_x_y(11) == (2, 2)
    assert CubicCode.to_x_y(12) == (1, 2)
    assert CubicCode.to_x_y(13) == (0, 2)
    assert CubicCode.to_x_y(15) == (-1, 1)
    assert CubicCode.to_x_y(16) == (-1, 0)

    assert CubicCode.to_x_y(27) == (3, 3)
    assert CubicCode.to_x_y(55) == (0, 4)
    assert CubicCode.to_x_y(62) == (-3, 0)
    assert CubicCode.to_x_y(44) == (4, -3)
    assert CubicCode.to_x_y(17) == (-2, -2)
    assert CubicCode.to_x_y(1) == (0, 0)

    assert CubicCode.to_x_y(381_589_793_238_462) == (-8_402_969, 9_767_162)
